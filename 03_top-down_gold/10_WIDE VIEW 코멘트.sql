...
-- ============================================================================
-- 6. WIDE_BIGQUERY_BEHAVIOR
-- ============================================================================
ALTER VIEW GN_DW.GOLD.WIDE_BIGQUERY_BEHAVIOR
    ALTER COLUMN DATE_SK                        COMMENT '행동 발생일 YYYYMMDD',
          ...
          COLUMN IDENTITY_BIGQUERY_MEMBER_ID    COMMENT 'DIM_MEMBER_IDENTITY.BIGQUERY_MEMBER_ID — BigQuery member_id (#112)',
          COLUMN BIGQUERY_EVENT_CATEGORY        COMMENT 'DIM_BIGQUERY_EVENT.EVENT_CATEGORY — 이벤트 카테고리 (#99)',
          COLUMN BIGQUERY_EVENT_LABEL           COMMENT 'DIM_BIGQUERY_EVENT.EVENT_LABEL — 이벤트 라벨 (#100)',
          COLUMN BIGQUERY_EVENT_ACTION          COMMENT 'DIM_BIGQUERY_EVENT.EVENT_ACTION — 이벤트 액션 (#101)',
          COLUMN BIGQUERY_UTM_SOURCE            COMMENT 'DIM_BIGQUERY_SOURCE.UTM_SOURCE — source',
          COLUMN BIGQUERY_UTM_MEDIUM            COMMENT 'DIM_BIGQUERY_SOURCE.UTM_MEDIUM — medium',
          COLUMN BIGQUERY_UTM_CONTENT           COMMENT 'DIM_BIGQUERY_SOURCE.UTM_CONTENT — 세션 수동 광고 콘텐츠 (#103)',
          COLUMN BIGQUERY_UTM_TERM              COMMENT 'DIM_BIGQUERY_SOURCE.UTM_TERM — 세션 수동 검색어 (#104)',
          COLUMN BIGQUERY_SOURCE_MEDIUM         COMMENT 'DIM_BIGQUERY_SOURCE.SOURCE_MEDIUM — 세션 소스/매체 (#109)',

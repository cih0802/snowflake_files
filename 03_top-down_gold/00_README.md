...
structure: 15 DIM + 12 FACT + 12 WIDE VIEW
naming: NN_이름 (작업/읽기 순서)
status: CURRENT — Top-down 1~10단계 완료 + 배포·적재 완료. 실측(2026-07-29) GOLD 27T+12V·SILVER 38T. 진행상태 정본=01_작업 계획.md
END-METADATA -->
...
| `09_빅테이블 VIEW.md` | 소비용 WIDE VIEW 12개 DDL (팩트×참조DIM 평탄화) | 9단계 ✅ (**배포 완료** — 실측 12) |
...
- 코어: **15 DIM + 12 FACT = 27 테이블** (FMM·FME·FTG_D·FTG_B·FSE·FGA·FAD·FEP·FBD + 광고 위성 FAD_B·FAD_D·FAD_BC) + 정보성 FK 38
- 소비 계층: **WIDE VIEW 12개**(팩트당 1개, 전 컬럼 COMMENT)
...
- 물리 배포: ✅ **완료** — 실측(2026-07-29) `GN_DW.GOLD` 27테이블 + WIDE VIEW 12개 · `GN_DW.SILVER` 38테이블. FACT 행수: FMM 40.05M·FSE 38.47M·FME 4.63M·FEP 1.13M·FAD 235,572(+위성 FAD_D 197,686·FAD_B 37,886·FAD_BC 5,327). **`FACT_TARGET_BIZ`만 0행**(=`CRM_BIZ_TARGET` 입고 대기 E-6).

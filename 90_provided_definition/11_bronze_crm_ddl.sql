...
create or replace TABLE GN_DW.BRONZE_CRM.SND_MEMBER_MAIL_LINK_LOG (
	...
	MBER_NO VARCHAR(50),
	LINK_ID VARCHAR(30),
	LINK_IMG_URL VARCHAR(1024),
	LINK_PAGE VARCHAR(255),
	AGENT VARCHAR(5),
	CLICK_DT TIMESTAMP_NTZ(9),
	FRST_REGIST_DT TIMESTAMP_NTZ(9),
	LINK_NM VARCHAR(30),
	_LOAD_DT TIMESTAMP_NTZ(9),
	_BATCH_ID VARCHAR(50),
...
create or replace TABLE GN_DW.BRONZE_CRM.TC_MKTNG_DTL_CD (
	...
	CD_ATRB3 VARCHAR(100),
	FRST_RGSTR_ID VARCHAR(30),
	FRST_RGSTR_DT TIMESTAMP_NTZ(9),
	LAST_UPDT_ID VARCHAR(30),
	LAST_UPDT_DT TIMESTAMP_NTZ(9),
	_LOAD_DT TIMESTAMP_NTZ(9),
	_BATCH_ID VARCHAR(50),
	_STDR_YM VARCHAR(6)
...
create or replace TABLE GN_DW.BRONZE_CRM.TM_CM_CMPGN_MNG (
	...
	CMMN_BRND NUMBER(10,0),
	MKTG_UTM NUMBER(10,0),
	MKTG_CHANNEL NUMBER(10,0),
	_LOAD_DT TIMESTAMP_NTZ(9),
	_BATCH_ID VARCHAR(50),
	_STDR_YM VARCHAR(6)
);
...
create or replace TABLE GN_DW.BRONZE_CRM.TM_PM_INSTT_ACNUT (
	ACNUT_SER_NO NUMBER(10,0),
	CPR_DIV_CD VARCHAR(3),
	ACNUT_DIV_CD VARCHAR(3),
	BANK_CD VARCHAR(10),
	ACCTNO VARCHAR(20),
	ACNUT_PRP VARCHAR(100),
	ACNUT_ABRV VARCHAR(30),
	CHRG_DEPT_CD VARCHAR(10),
	REGIST_USE_YN VARCHAR(1),
	USE_YN VARCHAR(1),
	FRST_RGSTR_ID VARCHAR(30),
	FRST_REGIST_DT TIMESTAMP_NTZ(9),
	LAST_UPDUSR_ID VARCHAR(30),
...
create or replace TABLE GN_DW.BRONZE_CRM.TM_PM_SETLE_CMPNY_ACNT (
	SETLE_CMPNY_ACNT_NO NUMBER(10,0),
	SETLE_CMPNY_ACNT_DIV_CD VARCHAR(3),
	SETLE_CMPNY_ACNT_ID VARCHAR(20),
	CPR_DIV_CD VARCHAR(3),
	ACNT_PRP VARCHAR(100),
	ACNUT_SER_NO NUMBER(10,0),
	RM VARCHAR(1000),
	USE_YN VARCHAR(1),
	FRST_RGSTR_ID VARCHAR(30),

...
| FDA 37.5K (FACT_DEV_ACHIEVEMENT) | MONTH_KEY·DEV_TYPE·GOAL_CNT(합 4.62M)·ACTUAL_CNT(합 2.29M)·ACHV_RATE · ✅**DEPT_ID/부서명(원천 확보)** | ORG_CORP(0/37,522)·ORG_DIVISION(0/37,522)·ORG_TEAM(0/37,522)·ORG_DEPARTMENT(0/37,522) (🔴 조직 계층 컬럼 전건 0/NULL · ⚠️ 원천 결손이 아니라 DIM_ORG 계층 도출 로직 미구현 · 부분 적재 한정 표기 필수) |

...
-- 오브젝트 확인
-- ═══════════════════════════════════════
SHOW TABLES IN SCHEMA GN_DW.BRONZE_CRM;    -- CRM 원천 (GA4/ERP/AGENCY는 BRONZE_BIGQUERY/ERP/AGENCY)
...
FROM GN_DW.INFORMATION_SCHEMA.TABLES
WHERE TABLE_SCHEMA IN ('BRONZE_CRM','BRONZE_AGENCY','BRONZE_ERP','BRONZE_BIGQUERY','SILVER','GOLD','SERVING')

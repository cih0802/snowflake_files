...
-- - 현업 활용도가 낮을 것으로 잠정판단되어 관리포인트를 줄이기 위해 보류
...
-- ============================================================================
-- 2. GOLD 스키마: ENGINEER에 USAGE + WIDE뷰 생성 + 테이블 5대 DML 부여
--    (※ 소유권은 GN_DW_ADMIN이 유지하고, ENGINEER는 적재/조회/뷰생성만 수행)
-- ============================================================================
GRANT USAGE, CREATE VIEW ON SCHEMA GN_DW.GOLD TO ROLE GN_DW_ENGINEER;
GRANT SELECT, INSERT, UPDATE, DELETE, TRUNCATE ON ALL TABLES IN SCHEMA GN_DW.GOLD TO ROLE GN_DW_ENGINEER;
GRANT SELECT, INSERT, UPDATE, DELETE, TRUNCATE ON FUTURE TABLES IN SCHEMA GN_DW.GOLD TO ROLE GN_DW_ENGINEER;
...
-- ============================================================================
-- 1. SILVER 스키마: ENGINEER에 USAGE + VIEW/SP생성 + 테이블 5대 DML 부여
-- ============================================================================
GRANT USAGE, CREATE TABLE, CREATE VIEW, CREATE PROCEDURE, CREATE FUNCTION ON SCHEMA GN_DW.SILVER TO ROLE GN_DW_ENGINEER;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA GN_DW.SILVER TO ROLE GN_DW_ENGINEER;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA GN_DW.SILVER TO ROLE GN_DW_ENGINEER;
...
GRANT USAGE ON SCHEMA GN_DW.BRONZE_BIGQUERY TO ROLE GN_DW_ENGINEER;
GRANT SELECT ON ALL TABLES IN SCHEMA GN_DW.BRONZE_BIGQUERY TO ROLE GN_DW_ENGINEER;
GRANT SELECT ON FUTURE TABLES IN SCHEMA GN_DW.BRONZE_BIGQUERY TO ROLE GN_DW_ENGINEER;

...
--   ENGINEER: USAGE, CREATE TABLE, CREATE VIEW, SELECT TABLES + OWNERSHIP VIEW (dbt 빌드 및 ETL)
GRANT USAGE, CREATE TABLE, CREATE VIEW ON SCHEMA GN_DW.GOLD TO ROLE GN_DW_ENGINEER;

...
>
> ### ⛔ 남은 미결 2건 — 다음 세션이 처리할 것
> - 🟠 **SV COMMENT 수치 기지 부채 14건 정리** — 게이트 `CMT_BASELINE` 에 등재돼 있다.
...
>   후보로 측정한 회원 미매칭 314행/74,880,671 과 **금액이 맞지 않아 원인 미특정**이다. `PAY_DE` 가 `'2020-1'`
>   형식이므로 월 파싱 경로부터 확인할 것.
>

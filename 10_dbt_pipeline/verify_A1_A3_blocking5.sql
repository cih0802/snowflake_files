...
-- ============================================================================
-- 대상: FACT_MEMBER_MONTHLY(A1)·FACT_MESSAGE_DISPATCH(구 FACT_SERVICE_EVENT)(A3)
-- 실행 시점: EXECUTE DBT PROJECT ... ARGS='build --select FACT_MEMBER_MONTHLY FACT_MESSAGE_DISPATCH' 후

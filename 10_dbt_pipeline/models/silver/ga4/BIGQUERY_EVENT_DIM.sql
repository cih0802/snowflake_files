...
--    ▶▶ unique(EVENT_NAME) 테스트 금지(순서9-C: 조합 grain 파괴 사고). BIGQUERY_EVENT relationships 는 존재성만 요구.
...
--    BIGQUERY_EVENT 의 것과 **미묘하게 달랐다**(BIGQUERY_EVENT 는 11컬럼). 기반 테이블에서 1회 승격하므로

...
--   대상 DB/스키마 = GN_DW / BRONZE_CRM(45) · BRONZE_AGENCY(4) · BRONZE_ERP(1) · BRONZE_GA4(3) = 53 테이블
-- =====================================================================
...
--   BRONZE_GA4      3 테이블 /     576,441 행 /   129,906,688 B
...
-- REVOKE SELECT ON ALL TABLES IN SCHEMA GN_DW.BRONZE_GA4    FROM SHARE mig_share;
...
-- REVOKE USAGE  ON SCHEMA GN_DW.BRONZE_GA4    FROM SHARE mig_share;

...
LINEAGE_MAP = {
    ...
    ("VIDEO_AD_CMPGN_DTLS", "CHNNL_CMPNY"):        ("CHANNEL_COMPANY",     "FACT_AD_BROADCAST.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "CHNNL_CMPNY_DIV_NM"): ("CHANNEL_COMPANY_TYPE", "FACT_AD_BROADCAST.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "SPOT_TY_NM"):         ("SPOT_TYPE",           "FACT_AD_BROADCAST.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "DAY_DIV"):            ("DAY_DIV",             "FACT_AD_BROADCAST.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "PRG_STRT_TIME"):      ("PRG_START_TIME",      "FACT_AD_BROADCAST.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "CTV_DIV"):            ("CTV_DIV",             "FACT_AD_BROADCAST.sql"),
    ...
    ("REBRDC_AD_CMPGN_DTLS", "BRDC_DIV"):          ("BRDC_DIV",            "FACT_AD_BROADCAST.sql"),
    ...
    ("DGT_AD_CMPGN_DTLS", "MEDIA_PM_CUST_CNT"):    ("MEDIA_POTENTIAL_CUST_CNT", "FACT_AD_DIGITAL.sql"),
    ("DGT_AD_CMPGN_DTLS", "CRM_DVLP_CNT"):         ("CRM_DEV_CNT",         "FACT_AD_DIGITAL.sql"),
    ("DGT_AD_CMPGN_DTLS", "PAGE_DIV_NM"):          ("PAGE_TYPE",           "FACT_AD_DIGITAL.sql"),
    ...
    ("DGT_AD_CMPGN_DTLS", "DVLP_UPRC"):            ("DEV_UNIT_PRICE_SRC",  "FACT_AD_DIGITAL.sql"),

...
LINEAGE_MAP = {
    # ── AGENCY VIDEO — 방송(영상)광고 속성 → FACT_AD_PERFORMANCE ──
    ("VIDEO_AD_CMPGN_DTLS", "TIME_RNG"):     ("TIME_BAND",      "FACT_AD_PERFORMANCE.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "CM_AREA"):      ("CM_POSITION",    "FACT_AD_PERFORMANCE.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "AD_STRT_TIME"): ("AD_START_TIME",  "FACT_AD_PERFORMANCE.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "BRDC_DATE"):    ("BROADCAST_DATE", "FACT_AD_PERFORMANCE.sql"),
    ("VIDEO_AD_CMPGN_DTLS", "AD_SEC"):       ("DURATION_SEC",   "DIM_AD_CREATIVE.sql"),
    # ── AGENCY REBRDC — 재방송광고 속성 ──
    ("REBRDC_AD_CMPGN_DTLS", "TIME_RNG_DIV_NM"): ("TIME_BAND", "FACT_AD_PERFORMANCE.sql"),
    ("REBRDC_AD_CMPGN_DTLS", "BRDC_TIME"):       ("TIME_BAND", "FACT_AD_PERFORMANCE.sql"),
    ("REBRDC_AD_CMPGN_DTLS", "RE_BRDC_TY_NM"):   ("RT_TYPE",   "FACT_AD_PERFORMANCE.sql"),
    # ── AGENCY DGT — 디지털광고 기기 ──
    # 실측: DEVICE_NM = M(138,274)·PC(59,412)·NULL(37,886) — GA4와 네이티브 동일 도메인.
    # 그러나 FACT_AD_PERFORMANCE 는 DEVICE_SK=0 하드코딩 → 235,572행 전건 (unknown).
    ...
    ("REBRDC_AD_CMPGN_DTLS", "DVLP_MBER_CNT"): ("GA_CONV_MEMBERS", "FACT_AD_PERFORMANCE.sql"),
    ("REBRDC_AD_CMPGN_DTLS", "DVLP_CNT"):      ("GA_CONV_CNT",     "FACT_AD_PERFORMANCE.sql"),

...
#         다시 침묵한다(O113 축).
STALE_TOKENS = [
    ("67 테이블", ("77",), "이관 총계 (현행 77)"),
    ("67개 테이블", ("77",), "이관 총계 (현행 77)"),
    ("= 67", ("77",), "이관 총계 (현행 77)"),
    ("69 테이블", ("77",), "이관 총계 (현행 77)"),
    ("69개 테이블", ("77",), "이관 총계 (현행 77)"),
    ("= 69", ("77",), "이관 총계 (현행 77)"),
    ("73 테이블", ("77",), "이관 총계 (현행 77)"),
    ("= 73", ("77",), "이관 총계 (현행 77)"),
    ("브론즈 50", ("60",), "브론즈 소계 (현행 60)"),
    ("브론즈 52", ("60",), "브론즈 소계 (현행 60)"),
    ("브론즈 56", ("60",), "브론즈 소계 (현행 60)"),
    ("52 테이블", ("60",), "브론즈 소계 (현행 60)"),
    ("52테이블", ("60",), "브론즈 소계 (현행 60)"),
    ("52개 테이블", ("60",), "브론즈 소계 (현행 60)"),

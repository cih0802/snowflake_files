...
TARGETS = [
    ...
    #      아예 보지 않았고, 실제로 원천 16번의 신규 테이블(SEARCH_CONSOLE_DATA2)을
...
#   🔴 [2026-09-15] 기준값을 2세대 올렸다 — 종전 목록은 「현행 69 · 브론즈 52」였고 그 값 자체가
#      stale 이 되어 있었다(2026-09-01 GA4/GSC 복귀 + 2026-09-15 CRM 개편 미반영).
#      ⇒ 현행 = **총계 77 · 브론즈 60 · CRM 50**. 옛 세대(67/69/73 · 50/52/56 · 45/46)를 모두 잡는다.
#      🟢 이 목록을 고칠 때는 **옛 값을 지우지 말고 새 세대를 추가**한다 — 지우면 그 세대 표기가
#         다시 침묵한다(O113 축).
#   🔴 [2026-09-17 O171] 기준값을 한 세대 더 올렸다 — GSC 신규 테이블 1개(SEARCH_CONSOLE_DATA2)로
#      **총계 78 · 브론즈 61 · CRM 50** 이 되었다. 종전 현행값(77 · 60)을 옛 세대로 내려 추가한다.
STALE_TOKENS = [
    ("67 테이블", ("78",), "이관 총계 (현행 78)"),
    ("67개 테이블", ("78",), "이관 총계 (현행 78)"),
    ("= 67", ("78",), "이관 총계 (현행 78)"),
    ("69 테이블", ("78",), "이관 총계 (현행 78)"),
    ("69개 테이블", ("78",), "이관 총계 (현행 78)"),
    ("= 69", ("78",), "이관 총계 (현행 78)"),
    ("73 테이블", ("78",), "이관 총계 (현행 78)"),
    ("= 73", ("78",), "이관 총계 (현행 78)"),
    ("77 테이블", ("78",), "이관 총계 (현행 78)"),
    ("77개 테이블", ("78",), "이관 총계 (현행 78)"),
    ("= 77", ("78",), "이관 총계 (현행 78)"),
    ("브론즈 50", ("61",), "브론즈 소계 (현행 61)"),
    ("브론즈 52", ("61",), "브론즈 소계 (현행 61)"),
    ("브론즈 56", ("61",), "브론즈 소계 (현행 61)"),
    ("브론즈 60", ("61",), "브론즈 소계 (현행 61)"),
    ("52 테이블", ("61",), "브론즈 소계 (현행 61)"),
    ("52테이블", ("61",), "브론즈 소계 (현행 61)"),
    ("52개 테이블", ("61",), "브론즈 소계 (현행 61)"),
    ("60 테이블", ("61",), "브론즈 소계 (현행 61)"),
    ("60개 테이블", ("61",), "브론즈 소계 (현행 61)"),
    ("CRM 45", ("50",), "CRM 소계 (현행 50)"),
    ("CRM 46", ("50",), "CRM 소계 (현행 50)"),
    ("CRM`(45)", ("50",), "CRM 소계 (현행 50)"),
    ("CRM`(46)", ("50",), "CRM 소계 (현행 50)"),
    ("CRM(46)", ("50",), "CRM 소계 (현행 50)"),
    ("04_2번", ("06번", "06_데이터마이그"), "SILVER DDL 옛 번호 (현행 06번)"),
    ("04_2_데이터마이그", ("06_데이터마이그",), "SILVER DDL 옛 파일명 (현행 06_)"),
    ("BRONZE_DDL_20260730", ("BRONZE_DDL.sql",), "04번 옛 파일명 (현행 = 날짜 없음)"),
    ("SILVER_DDL_20260820", ("SILVER_DDL.sql",), "06번 옛 파일명 (현행 = 날짜 없음)"),
]

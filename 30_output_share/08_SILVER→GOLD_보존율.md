...
> **측정일** 2026-09-02 · 모집단 = SILVER 물리 DATA 컬럼(감사 `DW_*` 5종 제외)
...
| `BIGQUERY_EVENT` | 39 | 15 | 24 | 0 | 0 | 38% | `FACT_GA_BEHAVIOR` |
| `BIGQUERY_EVENT_DIM` | 4 | 3 | 1 | 0 | 0 | 75% | `DIM_GA_EVENT` |
| `BIGQUERY_IDENTITY` | 7 | 0 | 0 | 7 | 0 | — | — |
| `BIGQUERY_REFINED_DATA` | 118 | 0 | 0 | 118 | 0 | — | — |
| `BIGQUERY_TRAFFIC_SOURCE` | 10 | 6 | 4 | 0 | 0 | 60% | `DIM_GA_SOURCE` |
...
| `AGENCY_AD_PERFORMANCE` | `CREATIVE_NM` | 255,419 | 255,419 | 6662 |
| `AGENCY_AD_PERFORMANCE` | `MEDIA_CHANNEL_NM` | 255,452 | 255,452 | 106 |
| `AGENCY_AD_PERFORMANCE` | `PROGRAM_NM` | 36,956 | 36,956 | 1877 |
| `AGENCY_AD_PERFORMANCE` | `SOURCE_SYSTEM` | 255,452 | 255,452 | 3 |
| `AGENCY_AD_PERFORMANCE` | `UPPER_CAMPAIGN_NM` | 57,932 | 57,932 | 32 |
| `BIGQUERY_DEVICE` | `BROWSER` | 1,165 | 1,165 | 24 |
| `BIGQUERY_DEVICE` | `DEVICE_CATEGORY` | 1,173 | 1,173 | 4 |
| `BIGQUERY_DEVICE` | `LANGUAGE` | 1,173 | 1,173 | 240 |
| `BIGQUERY_DEVICE` | `OS` | 1,164 | 1,164 | 10 |
| `BIGQUERY_DEVICE` | `PLATFORM` | 1,173 | 1,173 | 1 |
| `BIGQUERY_EVENT` | `BATCH_ORDERING_ID` | 22,798,044 | 22,798,044 | 20 |
| `BIGQUERY_EVENT` | `DEFAULT_CHANNEL_GROUP` | 19,649,814 | 19,649,814 | 17 |
| `BIGQUERY_EVENT` | `DEVICE_CATEGORY` | 29,279,135 | 29,279,135 | 4 |
| `BIGQUERY_EVENT` | `EVENT_DATE` | 29,279,135 | 29,279,135 | 90 |
| `BIGQUERY_EVENT` | `EVENT_SEQ` | 29,279,135 | 29,279,135 | 40 |
| `BIGQUERY_EVENT` | `EVENT_TIMESTAMP` | 29,279,135 | 29,279,135 | 18205049 |
| `BIGQUERY_EVENT` | `EVENT_TS` | 29,279,135 | 29,279,135 | 17701878 |
| `BIGQUERY_EVENT` | `GA_SESSION_KEY` | 29,266,240 | 29,266,240 | 3485095 |
| `BIGQUERY_EVENT` | `GA_SESSION_NUMBER` | 29,279,135 | 29,279,135 | 962 |
| `BIGQUERY_EVENT` | `GEO_CITY` | 29,181,558 | 29,181,558 | 3466 |
| `BIGQUERY_EVENT` | `GEO_COUNTRY` | 29,268,841 | 29,268,841 | 182 |
| `BIGQUERY_EVENT` | `ID_RESOLUTION` | 29,279,135 | 29,279,135 | 4 |
| `BIGQUERY_EVENT` | `ID_SCHEME` | 935,181 | 935,181 | 4 |
| `BIGQUERY_EVENT` | `LINK_TEXT` | 4,046,456 | 4,046,456 | 18903 |
| `BIGQUERY_EVENT` | `LINK_URL` | 3,349,655 | 3,349,655 | 155993 |
| `BIGQUERY_EVENT` | `OS` | 29,269,880 | 29,269,880 | 10 |
| `BIGQUERY_EVENT` | `PAGE_REFERRER` | 21,467,063 | 21,467,063 | 878744 |
| `BIGQUERY_EVENT` | `PAGE_TITLE` | 29,146,571 | 29,146,571 | 3339 |
| `BIGQUERY_EVENT` | `PLATFORM` | 29,279,135 | 29,279,135 | 1 |
| `BIGQUERY_EVENT` | `SRC_FILE_NAME` | 0 | 0 | 0 |
| `BIGQUERY_EVENT` | `SRC_TABLE` | 0 | 0 | 0 |
| `BIGQUERY_EVENT` | `USER_ID` | 935,181 | 935,181 | 69678 |
| `BIGQUERY_EVENT` | `USER_ID_FILLED` | 6,862,195 | 6,862,195 | 69678 |
| `BIGQUERY_EVENT` | `UTM_CAMPAIGN` | 19,589,355 | 19,589,355 | 864 |
| `BIGQUERY_EVENT_DIM` | `EVENT_NAME` | 83,205 | 83,205 | 50 |
| `BIGQUERY_TRAFFIC_SOURCE` | `UTM_CAMPAIGN` | 13,921 | 13,921 | 864 |
| `BIGQUERY_TRAFFIC_SOURCE` | `XCHAN_CAMPAIGN` | 13,971 | 13,971 | 917 |
| `BIGQUERY_TRAFFIC_SOURCE` | `XCHAN_MEDIUM` | 13,911 | 13,911 | 56 |
| `BIGQUERY_TRAFFIC_SOURCE` | `XCHAN_SOURCE` | 13,882 | 13,882 | 568 |

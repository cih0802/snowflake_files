...
| `11_O누적작업_점검_재현_절차.md` | **O 누적작업 비판적 검토(Inspection) 재현 가이드** — 프롬프트 + Phase 6단계 + **판정식 카탈로그 15종** + 실패 사례 · 🔴 잔여작업 목록이 아니다(정본 = 착수표) | 에이전트 | O 세션 **8~10개** 누적 · 게이트 도구 수정 직후 · 계정 재구축 · **객체 개명 직후** |

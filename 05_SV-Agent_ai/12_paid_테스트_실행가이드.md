...
> **선행**: `02_GN_DW_building/08_After_Deploy_DBT.sql`(§G helper 뷰) → `05_1~05_7_SV_DDL_*.sql` → `09_1_AGENT_생성.sql` → **`09_2_AGENT_버전업.sql`** 순차 실행 완료(Agent 2 + 스펙 반영 + CoWork 연결 상태).
